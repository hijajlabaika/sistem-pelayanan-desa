...
if (isset($_POST['kirim'])) {
    ...
    $nama_file_sppktp = $_FILES["kirim_sppktp"]['name'];

    $direktori = "../download/";

    move_uploaded_file($_FILES['kirim_sppktp']['tmp_name'], $direktori . $nama_file_sppktp);

    $result = mysqli_query($connection, "UPDATE surat_sppktp SET status_sppktp='$status_sppktp', keterangan_sppktp='$keterangan_sppktp', nama_file_sppktp='$nama_file_sppktp' WHERE sppktp_id='$id'");
...
<head>
    ...
    <title>Kirim SPPKTP | Staff Desa</title>
                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3 mt-5">
                                        <input type="hidden" name="sppktp_id" value="<?= $row["sppktp_id"]; ?>" required>
                                        <input type="hidden" name="status_sppktp" value="selesai" required>
                                        <input type="hidden" name="keterangan_sppktp" value="Selamat pengajuan surat sudah selesai. Silahkan klik download untuk mendapatkan suratnya." required>
                                        <input type="file" name="kirim_sppktp" class="form-control" id="floatingInput" placeholder="name@example.com" required>
