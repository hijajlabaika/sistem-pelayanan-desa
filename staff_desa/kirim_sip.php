...
if (isset($_POST['kirim'])) {
    ...
    $nama_file_sip = $_FILES["kirim_sip"]['name'];

    $direktori = "../download/";

    move_uploaded_file($_FILES['kirim_sip']['tmp_name'], $direktori . $nama_file_sip);

    $result = mysqli_query($connection, "UPDATE surat_sip SET status_sip='$status_sip', keterangan_sip='$keterangan_sip', nama_file_sip='$nama_file_sip' WHERE sip_id='$id'");
...
<head>
    ...
    <title>Kirim SIP | Staff Desa</title>
                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3 mt-5">
                                        <input type="hidden" name="sip_id" value="<?= $row["sip_id"]; ?>" required>
                                        <input type="hidden" name="status_sip" value="selesai" required>
                                        <input type="hidden" name="keterangan_sip" value="Selamat pengajuan surat sudah selesai. Silahkan klik download untuk mendapatkan suratnya." required>
                                        <input type="file" name="kirim_sip" class="form-control" id="floatingInput" placeholder="name@example.com" required>
