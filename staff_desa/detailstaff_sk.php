...
$result = mysqli_query($connection, "SELECT * FROM surat_sk WHERE sk_id = $id");
$row = mysqli_fetch_array($result);

$no_surat_sk = $no_sk . sprintf("%03s", $id) . $nomor;

if (isset($_POST['ubah'])) {

    $nik_masyarakat_sk = $_POST['nik_masyarakat_sk'];
    $status_sk = $_POST['status_sk'];
    $keterangan_sk = $_POST['keterangan_sk'];
    $no_surat_sk = $_POST['no_surat_sk'];


    $result = mysqli_query($connection, "UPDATE surat_sk SET status_sk='$status_sk', keterangan_sk='$keterangan_sk', no_surat_sk='$no_surat_sk' WHERE sk_id='$id'");
...
<head>
    ...
    <title>Detail SK | Staff Desa</title>
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="hidden" class="form-control" id="nik" readonly name="id" value="<?= $row["sk_id"]; ?>" required>
                                    <input type="text" class="form-control" id="nik" readonly name="nik_masyarakat_sk" value="<?= $row["nik_masyarakat_sk"]; ?>" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="nama" readonly name="keperluan_sk" value="<?= $row["keperluan_sk"]; ?>" required>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="../masyarakat/gambar/<?= $row["scan_suratrs_sk"] ?>" alt="" width="250" height="250">
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="../masyarakat/gambar/<?= $row["scan_kk_sk"] ?>" alt="" width="250" height="250">
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="../masyarakat/gambar/<?= $row["scan_ktp_sk"] ?>" alt="" width="250" height="250">
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="agama" name="tgl_req_sk" readonly value="<?= $row["tgl_req_sk"]; ?>" required>
                                </div>
                            </div>
                            <br>
                            <input type="hidden" name="status_sk" value="acc_staff" required>
                            <input type="hidden" name="keterangan_sk" value="Data lengkap! Surat sedang di proses oleh kepala desa" required>
                            <input type="hidden" name="no_surat_sk" value="<?= $no_surat_sk; ?>" required>
                        </div>
