...
$result = mysqli_query($connection, "SELECT * FROM surat_sku WHERE sku_id = $id");
$row = mysqli_fetch_array($result);

$no_surat_sku = $no_sku . sprintf("%03s", $id) . $nomor;

if (isset($_POST['ubah'])) {

    $nik_masyarakat_sku = $_POST['nik_masyarakat_sku'];
    $status_sku = $_POST['status_sku'];
    $keterangan_sku = $_POST['keterangan_sku'];
    $no_surat_sku = $_POST['no_surat_sku'];


    $result = mysqli_query($connection, "UPDATE surat_sku SET status_sku='$status_sku', keterangan_sku='$keterangan_sku', no_surat_sku='$no_surat_sku' WHERE sku_id='$id'");
...
<head>
    ...
    <title>Detail SKU | Staff Desa</title>
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="hidden" class="form-control" id="nik" readonly name="id" value="<?= $row["sku_id"]; ?>" required>
                                    <input type="text" class="form-control" id="nik" readonly name="nik_masyarakat_sku" value="<?= $row["nik_masyarakat_sku"]; ?>" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="nama" readonly name="keperluan_sku" value="<?= $row["keperluan_sku"]; ?>" required>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="../masyarakat/gambar/<?= $row["scan_ktp_sku"] ?>" alt="" width="250" height="250">
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="../masyarakat/gambar/<?= $row["scan_kk_sku"] ?>" alt="" width="250" height="250">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="agama" name="tgl_req_sku" readonly value="<?= $row["tgl_req_sku"]; ?>" required>
                                </div>
                            </div>
                            <br>

                            <input type="hidden" name="status_sku" value="acc_staff" required>
                            <input type="hidden" name="keterangan_sku" value="Data lengkap! Surat sedang di proses oleh kepala desa" required>
                            <input type="hidden" name="no_surat_sku" value="<?= $no_surat_sku; ?>" required>
