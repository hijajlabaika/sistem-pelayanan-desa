...
$result = mysqli_query($connection, "SELECT * FROM surat_sppktp WHERE sppktp_id = $id");
$row = mysqli_fetch_array($result);

$no_surat_sppktp = $no_sppktp . sprintf("%03s", $id) . $nomor;

if (isset($_POST['ubah'])) {

    $nik_masyarakat_sppktp = $_POST['nik_masyarakat_sppktp'];
    $status_sppktp = $_POST['status_sppktp'];
    $keterangan_sppktp = $_POST['keterangan_sppktp'];
    $no_surat_sppktp = $_POST['no_surat_sppktp'];


    $result = mysqli_query($connection, "UPDATE surat_sppktp SET status_sppktp='$status_sppktp', keterangan_sppktp='$keterangan_sppktp', no_surat_sppktp='$no_surat_sppktp' WHERE sppktp_id='$id'");
...
<head>
    ...
    <title>Detail SPPKTP | Staff Desa</title>
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="hidden" class="form-control" id="nik" readonly name="id" value="<?= $row["sppktp_id"]; ?>" required>
                                    <input type="text" class="form-control" id="nik" readonly name="nik_masyarakat_sppktp" value="<?= $row["nik_masyarakat_sppktp"]; ?>" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="nama" readonly name="keperluan_sppktp" value="<?= $row["keperluan_sppktp"]; ?>" required>
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="../masyarakat/gambar/<?= $row["scan_kk_sppktp"] ?>" alt="" width="250" height="250">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="agama" name="tgl_req_sppktp" readonly value="<?= $row["tgl_req_sppktp"]; ?>" required>
                                </div>
                            </div>
                            <br>

                            <input type="hidden" name="status_sppktp" value="acc_staff" required>
                            <input type="hidden" name="keterangan_sppktp" value="Data lengkap! Surat sedang di proses oleh kepala desa" required>
                            <input type="hidden" name="no_surat_sppktp" value="<?= $no_surat_sppktp; ?>" required>
