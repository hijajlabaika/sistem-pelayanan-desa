...
if (isset($_POST['ubah'])) {
    ...
    $result = mysqli_query($connection, "UPDATE surat_sku SET status_sku='$status_sku', keterangan_sku='$keterangan_sku' WHERE sku_id='$id'");
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="status_sku" id="jekel" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="keterangan_sku" id="color" class="form-control" required>
