...
if (isset($_POST['ubah'])) {
    ...
    $result = mysqli_query($connection, "UPDATE surat_skd SET status_skd='$status_skd', keterangan_skd='$keterangan_skd' WHERE skd_id='$id'");
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="status_skd" id="jekel" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="keterangan_skd" id="color" class="form-control" required>
