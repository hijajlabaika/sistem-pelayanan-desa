...
if (isset($_POST['filter'])) {
    ...
    $date = $_POST['date'];
    $result_sppktp = mysqli_query($connection, "SELECT * FROM surat_sppktp WHERE MONTH(tgl_req_sppktp) = '$date' AND status_sppktp = 'selesai'");
} else {
    $result_sppktp = mysqli_query($connection, "SELECT * FROM surat_sppktp WHERE status_sppktp = 'selesai'");
}
...
<head>
    ...
    <title>Laporan SK | Kepala Desa</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="cetak_laporan_sppktp.php" target="_blank" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Cetak</a>
                            <br>
                            <br>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <p class="card-title" style="text-align: center;">
                                    <b> BUKU SURAT PEMBUATAN KTP KELUAR REGISTER PELAYANAN</b>
                                </p>
                                <br>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?= $row_sppktp['nama_sppktp']; ?>
                                                </td>
                                                <td>
                                                    <?= $row_sppktp['alamat_sppktp'] ?>
                                                </td>
                                                <td>
                                                    <?= $row_sppktp['no_surat_sppktp'] ?>
                                                </td>
                                            </tr>
                                            <?php $no++; ?>
                                        <?php endwhile; ?>
