...
if (isset($_POST['filter'])) {
    ...
    $date = $_POST['date'];
    $result_sku = mysqli_query($connection, "SELECT * FROM surat_sku WHERE MONTH(tgl_req_sku) = '$date' AND status_sku = 'selesai'");
} else {
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="cetak_laporan_sku.php" target="_blank" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Cetak</a>
                            <br>
                            <br>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <p class="card-title" style="text-align: center;">
                                    <b> BUKU SURAT KETERANGAN IZIN USAHA KELUAR REGISTER PELAYANAN</b>
                                </p>
                                <br>
