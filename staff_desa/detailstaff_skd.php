...
$no_surat_skd = $no_skd . sprintf("%03s", $id) . $nomor;


if (isset($_POST['ubah'])) {

    $nik_masyarakat_skd = $_POST['nik_masyarakat_skd'];
    $status_skd = $_POST['status_skd'];
    $keterangan_skd = $_POST['keterangan_skd'];
    $no_surat_skd = $_POST['no_surat_skd'];


    $result = mysqli_query($connection, "UPDATE surat_skd SET status_skd='$status_skd', keterangan_skd='$keterangan_skd', no_surat_skd='$no_surat_skd' WHERE skd_id='$id'");
...
<head>
    ...
    <title>Detail SKD | Staff Desa</title>
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="hidden" class="form-control" id="nik" readonly name="id" value="<?= $row["skd_id"]; ?>" required>
                                    <input type="text" class="form-control" id="nik" readonly name="nik_masyarakat_skd" value="<?= $row["nik_masyarakat_skd"]; ?>" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="nama" readonly name="keperluan_skd" value="<?= $row["keperluan_skd"]; ?>" required>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="../masyarakat/gambar/<?= $row["scan_ktp_skd"] ?>" alt="" width="250" height="250">
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="../masyarakat/gambar/<?= $row["scan_kk_skd"] ?>" alt="" width="250" height="250">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="agama" name="tgl_req_skd" readonly value="<?= $row["tgl_req_skd"]; ?>" required>
                                </div>
                            </div>
                            <br>

                            <input type="hidden" name="status_skd" value="acc_staff" required>
                            <input type="hidden" name="keterangan_skd" value="Data lengkap! Surat sedang di proses oleh kepala desa" required>
                            <input type="hidden" name="no_surat_skd" value="<?= $no_surat_skd; ?>" required>
