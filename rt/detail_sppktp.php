...
if (isset($_POST['ubah'])) {
    ...
    $result = mysqli_query($connection, "UPDATE surat_sppktp SET status_sppktp='$status_sppktp', keterangan_sppktp='$keterangan_sppktp' WHERE sppktp_id='$id'");
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="status_sppktp" id="jekel" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="keterangan_sppktp" id="color" class="form-control" required>
