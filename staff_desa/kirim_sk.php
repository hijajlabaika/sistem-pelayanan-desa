...
if (isset($_POST['kirim'])) {
    ...
    $nama_file_sk = $_FILES["kirim_sk"]['name'];

    $direktori = "../download/";

    move_uploaded_file($_FILES['kirim_sk']['tmp_name'], $direktori . $nama_file_sk);

    $result = mysqli_query($connection, "UPDATE surat_sk SET status_sk='$status_sk', keterangan_sk='$keterangan_sk', nama_file_sk='$nama_file_sk' WHERE sk_id='$id'");
...
<head>
    ...
    <title>Kirim SK | Staff Desa</title>
                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3 mt-5">
                                        <input type="hidden" name="sk_id" value="<?= $row["sk_id"]; ?>" required>
                                        <input type="hidden" name="status_sk" value="selesai" required>
                                        <input type="hidden" name="keterangan_sk" value="Selamat pengajuan surat sudah selesai. Silahkan klik download untuk mendapatkan suratnya." required>
                                        <input type="file" name="kirim_sk" class="form-control" id="floatingInput" placeholder="name@example.com" required>
