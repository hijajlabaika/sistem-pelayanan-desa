...
if (isset($_POST['ubah'])) {
    ...
    $result = mysqli_query($connection, "UPDATE surat_sip SET status_sip='$status_sip', keterangan_sip='$keterangan_sip' WHERE sip_id='$id'");
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="status_sip" id="jekel" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="keterangan_sip" id="color" class="form-control" required>
