...
if (isset($_POST['filter'])) {
    ...
    $date = $_POST['date'];
    $result_sk = mysqli_query($connection, "SELECT * FROM surat_sk WHERE MONTH(tgl_req_sk) = '$date' AND status_sk = 'selesai'");
} else {
    $result_sk = mysqli_query($connection, "SELECT * FROM surat_sk WHERE status_sk = 'selesai'");
}
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="cetak_laporan_sk.php" target="_blank" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Cetak</a>
                            <br>
                            <br>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <p class="card-title" style="text-align: center;">
                                    <b> BUKU SURAT KELAHIRAN KELUAR REGISTER PELAYANAN</b>
                                </p>
                                <br>
