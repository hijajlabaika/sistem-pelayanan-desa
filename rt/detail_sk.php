...
if (isset($_POST['ubah'])) {
    ...
    $result = mysqli_query($connection, "UPDATE surat_sk SET status_sk='$status_sk', keterangan_sk='$keterangan_sk' WHERE sk_id='$id'");
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="status_sk" id="jekel" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="keterangan_sk" id="color" class="form-control" required>
