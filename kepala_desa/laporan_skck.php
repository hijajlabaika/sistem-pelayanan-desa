...
if (isset($_POST['filter'])) {
    ...
    $date = $_POST['date'];
    $result_skck = mysqli_query($connection, "SELECT * FROM surat_skck WHERE MONTH(tgl_req_skck) = '$date' AND status_skck = 'selesai'");
} else {
...
<head>
    ...
    <title>Laporan SKCK | Kepala Desa</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="cetak_laporan_skck.php" target="_blank" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Cetak</a>
                            <br>
                            <br>
