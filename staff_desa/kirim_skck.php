...
if (isset($_POST['kirim'])) {
    ...
    $nama_file_skck = $_FILES["kirim_skck"]['name'];

    $direktori = "../download/";

    move_uploaded_file($_FILES['kirim_skck']['tmp_name'], $direktori . $nama_file_skck);

    $result = mysqli_query($connection, "UPDATE surat_skck SET status_skck='$status_skck', keterangan_skck='$keterangan_skck', nama_file_skck='$nama_file_skck' WHERE skck_id='$id'");
...
<head>
    ...
    <title>Kirim SKCK | Staff Desa</title>
                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3 mt-5">
                                        <input type="hidden" name="skck_id" value="<?= $row["skck_id"]; ?>" required>
                                        <input type="hidden" name="status_skck" value="selesai" required>
                                        <input type="hidden" name="keterangan_skck" value="Selamat pengajuan surat sudah selesai. Silahkan klik download untuk mendapatkan suratnya." required>
                                        <input type="file" name="kirim_skck" class="form-control" id="floatingInput" placeholder="name@example.com" required>
