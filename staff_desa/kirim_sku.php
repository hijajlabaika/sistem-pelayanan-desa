...
if (isset($_POST['kirim'])) {
    ...
    $nama_file_sku = $_FILES["kirim_sku"]['name'];

    $direktori = "../download/";

    move_uploaded_file($_FILES['kirim_sku']['tmp_name'], $direktori . $nama_file_sku);

    $result = mysqli_query($connection, "UPDATE surat_sku SET status_sku='$status_sku', keterangan_sku='$keterangan_sku', nama_file_sku='$nama_file_sku' WHERE sku_id='$id'");
        ...
        <div id="layoutSidenav_content">
            <main>
                <!-- <div class="card position-absolute top-50 start-50 translate-middle" style="width: 50rem;">
                    <div class="card-body">
                        <h5 class="card-title">ACC Surat</h5>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Tanggal ACC</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="agama" name="keterangan_sip" required>
                            </div>
                        </div>
                    </div>
                </div> -->
                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3 mt-5">
                                        <input type="hidden" name="sku_id" value="<?= $row["sku_id"]; ?>" required>
                                        <input type="hidden" name="status_sku" value="selesai" required>
                                        <input type="hidden" name="keterangan_sku" value="Selamat pengajuan surat sudah selesai. Silahkan klik download untuk mendapatkan suratnya." required>
                                        <input type="file" name="kirim_sku" class="form-control" id="floatingInput" placeholder="name@example.com" required>
