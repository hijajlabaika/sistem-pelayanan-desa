...
$no_surat_skck = $no_skck . sprintf("%03s", $id) . $nomor;
...
if (isset($_POST['ubah'])) {
    ...
    $no_surat_skck = $_POST['no_surat_skck'];


    $result = mysqli_query($connection, "UPDATE surat_skck SET status_skck='$status_skck', keterangan_skck='$keterangan_skck', no_surat_skck='$no_surat_skck' WHERE skck_id='$id'");
...
<head>
    ...
    <title>Detail SKCK | Staff Desa</title>
                ...
                <div class="card card-primary">
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="status_skck" value="acc_staff" required>
                            <input type="hidden" name="keterangan_skck" value="Data lengkap! Surat sedang di proses oleh kepala desa" required>
                            <input type="hidden" name="no_surat_skck" value="<?= $no_surat_skck; ?>" required>
