...
if (isset($_POST['acc'])) {
    ...
    $tanggal_acc_skd = $_POST['tanggal_acc_skd'];


    $result = mysqli_query($connection, "UPDATE surat_skd SET status_skd='$status_skd', tanggal_acc_skd='$tanggal_acc_skd' WHERE skd_id='$skd_id'");
...
<head>
    ...
    <title>Tampil Surat SKD | Kepala Desa</title>
                                ...
                                <div class="card-body">
                                    <form action="" method="POST">
                                        <div class="form-floating mb-3 mt-5">
                                            <input type="hidden" name="skd_id" value="<?= $row_skd["skd_id"]; ?>" required>
                                            <input type="hidden" name="status_skd" value="acc_desa" required>
                                            <input type="date" name="tanggal_acc_skd" class="form-control" id="floatingInput" placeholder="name@example.com" required>
                                    ...
                                    <div class="d-grid gap-2 mt-2">
                                        <a href="request_skd.php" class="btn btn-danger">BATAL</a>
                                    </div>
                                </div>
                            </div>
